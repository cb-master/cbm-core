...
class Middleware
{
    ...
    public static function create(array $inputs)
    {
        // Validate Inputs
        if(!isset($inputs[1])){
            Message::show("NAME MISSING", "Middleware Name Not Found!", "red");
        }elseif(!Validate::alpha($inputs[1])){
            Message::show("INVALID MIDDLEWARE", "Invalid Middleware Name! Input Should Contain Only Alphabets.", "red");
        }
        ...
        if(file_exists($middleware_file)){
            Message::show("MIDDLEWARE EXIST", "Middleware '{$inputs[1]}' Already Exist.", "red");
        }
        ...
        // Show Message
        Message::show("SUCCESS", "Middleware '{$name}' Created Successfully.");
    }
    ...
    public static function rename(array $inputs)
    {
        // Validate Inputs
        if(!isset($inputs[1])){
            Message::show("NAME MISSING", "Old Middleware Name Not Found!", "red");
        }elseif(!isset($inputs[2])){
            Message::show("NAME MISSING", "New Middleware Name Not Found!", "red");
        }elseif(!Validate::alpha($inputs[1])){
            Message::show("INVALID MIDDLEWARE", "Invalid Old Middleware Name '{$inputs[1]}'! Input Should Contain Only Alphabets.", "red");
        }elseif(!Validate::alpha($inputs[2])){
            Message::show("INVALID MIDDLEWARE", "Invalid New Middleware Name '{$inputs[1]}'! Input Should Contain Only Alphabets.", "red");
        }
        ...
        if(!file_exists($old_middleware_file)){
            Message::show("NOT FOUND", "Middleware '{$inputs[1]}' Does Not Exist.", "red");
        }
        ...
        // Show Message
        Message::show("SUCCESS", "Middleware '{$old_name}' Renamed To '{$inputs[2]}' Successfully.");
    }
    ...
    public static function pop(array $inputs)
    {
        ...
        if(!isset($inputs[1])){
            ...
            Message::show("INVALID MIDDLEWARE", "Invalid Middleware Name '{$inputs[1]}'! Input Should Contain Only Alphabets.", "red");
        }
        ...
        // Show Message
        Message::show("SUCCESS", "Middleware '{$name}' Removed Successfully.");
    }
}